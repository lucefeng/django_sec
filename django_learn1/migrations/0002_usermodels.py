    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nickname', models.CharField(verbose_name='用户昵称', max_length=20, null=True)),
                ('mobile', models.CharField(verbose_name='电话', max_length=11, null=True)),
                ('address', models.CharField(verbose_name='住址', max_length=100, null=True)),
                ('sex', models.CharField(verbose_name='性别', max_length=10, null=True)),
                ('head_img', models.ImageField(verbose_name='头像', null=True, upload_to='%y/%m')),
